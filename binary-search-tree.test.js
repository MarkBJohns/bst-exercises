...
describe("insert", function() { 
  it("inserts a node at the correct position", function() { // PASSED
  ...
  it("inserts a node at the root if there is nothing there", function() { // PASSED
    var binarySearchTree = new BinarySearchTree();
...
describe("find", function() {
  it("finds a node correctly", function() { // PASSED
  ...
  it("returns undefined if a node is not found", function() { // PASSED
    let binarySearchTree = new BinarySearchTree();
    binarySearchTree
      .insert(15)
      .insert(20)
...
describe("dfsPreOrder", function() {
  it("returns an array of values found with DFS Pre Order", function() { // PASSED
    let binarySearchTree = new BinarySearchTree();
    binarySearchTree
      .insert(15)
      .insert(20)
...
describe("dfsInOrder", function() {
  it("returns an array of values found with DFS In Order", function() { // PASSED
    let binarySearchTree = new BinarySearchTree();
    binarySearchTree
      .insert(15)
      .insert(20)
...
describe("dfsPostOrder", function() {
  it("returns an array of values found with DFS Post Order", function() { // PASSED
    let binarySearchTree = new BinarySearchTree();
    binarySearchTree
      .insert(15)
      .insert(20)
...
describe("BFS", function() {
  it("should return the correct output", function() { // PASSED
    let binarySearchTree = new BinarySearchTree();
    binarySearchTree
      .insert(15)
      .insert(20)
